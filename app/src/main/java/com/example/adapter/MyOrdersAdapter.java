...
public class MyOrdersAdapter extends RecyclerView.Adapter<MyOrdersAdapter.ViewHolder>{
    ...
    public MyOrdersAdapter(Activity context, int orderitem, List<MyOrder> myOrdersList, ItemClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnreorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickListener.onReOrderClick(myOrdersList.get(holder.getAdapterPosition()));
